...
<?php
// Verificamos si el parámetro "tope" existe y es un número válido
if (isset($_GET['tope']) && is_numeric($_GET['tope'])) {
    $tope = intval($_GET['tope']);
    echo '<h3>Lista de productos con un número de unidades menor o igual a ' . htmlspecialchars($tope) . '</h3>';
    ...
    // Si no se ha enviado el parámetro "tope" o no es válido
    echo '<h3>Por favor, proporciona un valor válido para el tope.</h3>';
}
?>
