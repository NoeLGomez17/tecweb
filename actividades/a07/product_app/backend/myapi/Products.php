...
class Products extends DataBase{
    ...
    //$user = 'root', $pass = '123456789', $db)
    public function __construct($user = 'root', $pass = '123456789', $db = 'marketzone') {
    ...
    public function add($producto){
        ...
        if(!empty($producto)) {
            ...
            //Se considera que los datos ya fueron validos
    ...
    public function single($string = _GET['id']){
        ...
        $this->response = array(
            'status'  => 'Error',
            'message' => 'No se encontra el producto'
        );
